...
public class ArrayBag<E> implements BagInterface<E> {
    ...
    */
    ...
    public boolean equals(Object other) {
        ...
        ArrayBag other_bag = (ArrayBag) other;

        
        if (this.size != other_bag.size) return false;

        int index = 0;

        while(index < size)
        {
            if (!(this.getFrequencyOf(bag[index]) == other_bag.getFrequencyOf(bag[index]))) return false;
            index ++;
        }
